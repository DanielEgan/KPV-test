...
enrollProfile(wavfile,function(result){
    console.log(result);
});

    function enrollProfile(file, callback) {
        ...
        var options = {
            url: 'https://api.projectoxford.ai/spid/v1.0/verificationProfiles/1470311b-5ead-4311-bce6-d4688959b911/enroll ',
